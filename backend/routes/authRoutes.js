...
const { register, login, getMe, getUsers, updateUserStatus, resetUserPassword, changePassword, updateFcmToken, logout, acceptHint } = require('../controllers/authController');
